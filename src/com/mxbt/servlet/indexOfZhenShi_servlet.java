 ...
 */
@WebServlet("/indexofzhenshi_servlet")
public class indexOfZhenShi_servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
			...
			list= forindex.getIndexDataOfZhenShiByNewest();
			Gson gson = new Gson();
			...
			mPrintWriter.close();
				...
				list= forindex.getIndexDataOfZhenShiByHotest();
				Gson gson = new Gson();
				String result  = gson.toJson(list);
				mPrintWriter.write(result);
				mPrintWriter.close();
